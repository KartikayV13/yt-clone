...
import { IoIosSearch, IoMdMicOff } from "react-icons/io";
import { MdVideoCall } from "react-icons/md";
import { FaBell } from "react-icons/fa";
import { RiAccountCircleLine } from "react-icons/ri";
import { FiMoon, FiSun } from "react-icons/fi";

import Desktop_logo from "../../images/yt_desktop.png";
...
const Header = () => {
  ...
  return (
    <>
      <div
        className={`sticky top-0 z-10 flex flex-row items-center justify-between h-16 border-b-2 px-3 md:px-5 ${
